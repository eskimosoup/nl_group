module Optimadmin
  class AdditionalBlocksController < Optimadmin::ApplicationController
    ...
    def additional_block_params
      params.require(:additional_block).permit(:additional_row_id, :style, :name, :classes, :display, :has_title, :has_paragraph, :has_buttons, additional_animation_attributes: [:animation_type, :animation_delay, :active])
    end
  end
end
